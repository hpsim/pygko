...
setup(
    ...
    description='A package bringing Ginkgo functionalities to python',
    long_description='{}\n{}'.format(
    ...
    url='https://github.com/hpsim/PyGko',
    ...
    project_urls={
        'Documentation': 'https://PyGko.readthedocs.io/',
        'Changelog': 'https://PyGko.readthedocs.io/en/latest/changelog.html',
        'Issue Tracker': 'https://github.com/hpsim/PyGko/issues',
    },
    keywords=[
